...
const WHATSAPP_MESSAGE =
  'Hi CodeArc, I would like to discuss a website, app or business software project.';
  ...
  return (
    <aside className={styles.dock} aria-label="Quick contact">
      ...
      <a
        ...
        aria-label="Chat with CodeArc on WhatsApp"
        title="Chat with CodeArc on WhatsApp"
      >
        <span className={styles.icon} aria-hidden="true">
          <WhatsAppIcon />
        </span>
